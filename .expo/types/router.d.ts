...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(home)/` | `/(home)` | `/(patient)/CadastroPaciente` | `/CadastroPaciente` | `/(patient)/` | `/(patient)` | `/ForgotPassword` | `/Register` | `/styles/AuthStyles` | `/styles/CadastroPacienteStyles`;
  // prettier-ignore
